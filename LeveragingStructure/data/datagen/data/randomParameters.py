# AUTOGENERATED! DO NOT EDIT! File to edit: 01_E_Datagen_Random_Parameters.ipynb (unless otherwise specified).

__all__ = ['NormalMixRandomParameters', 'NormalMixPNParameters', 'min_aucpn', 'NormalMixPNParameters2',
           'AUCFromDistributions']
...
from .datagen import MVNormalMixDG
...
class NormalMixRandomParameters:
    ...
    def move_mean_out(self, irr_range):
        ir_pos, _ = self.componentIrreducibilitySampling()
        #pdb.set_trace()
    ...
    def perturb2SatisfyMetrics(self, aucpn_range, irr_vec,timeoutMins=1):
        ...
        while not self.isMetricSatisfied(aucpn_range, irr_vec):
            ...
            if time.time() > timeout:
                ...
                print(f"current time: {time.time()} - will time out at {timeout}")
